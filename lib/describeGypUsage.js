 ...
 */
function retrieveLastMonthsDownloadNumbers(packageNameMap, getDownloadStats) {
...
function docsAndDownloads(docs, getDownloadStats) {
  ...
  return retrieveLastMonthsDownloadNumbers(projectGypDependencies,
    getDownloadStats)
        ...
        .reduce(function (histogram, listOfGypProjects) {
          return histogram.update(listOfGypProjects.size,
            function (currentCountValue) {
              return (currentCountValue ? currentCountValue : 0) + 1;
            });
          }, Immutable.Map());
          ...
          .reduce(function (histogram, listOfGypProjects, projectName) {
            return histogram.update(listOfGypProjects.size,
              function (currentDownloadValue) {
                return (currentDownloadValue ? currentDownloadValue : 0) +
